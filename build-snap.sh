...
rm -f "$SNAP_DIR/easyedit_1.5.1_amd64.snap"
echo "========================"
echo "building snap --destructive-mode package..."
snapcraft pack --destructive-mode --output "$SNAP_DIR/easyedit_1.5.1_amd64.snap"
echo "========================"
echo "installing new built snap package..."
sudo snap install --classic --dangerous "$SNAP_DIR/easyedit_1.5.1_amd64.snap"
echo "========================"
